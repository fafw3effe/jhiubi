...
function playVideo() {
    ...
    if (currentMovie && currentMovie.dl) {
        try {
            videoPlayer.innerHTML = `
            <video controls autoplay preload="metadata"
                poster="https://image.tmdb.org/t/p/w533_and_h300_bestv2/${currentMovie.bgi || currentMovie.im}.jpg"
                style="width:100%;height:100%;object-fit:contain;background:#000;"
                onerror="this.style.display='none';this.nextElementSibling.style.display='block';">
                <source src="${currentMovie.dl}" type="video/mp4">
...
function openModal(movie) {
    ...
    if (movie.dl && !hideVideoPlayer) {
        try {
            ...
            // Hide play button if video is auto-loaded
